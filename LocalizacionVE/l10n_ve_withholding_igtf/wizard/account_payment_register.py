...
class AccountPaymentRegister(models.TransientModel):
	...
	def _compute_apply_igtf(self):
		for pay in self:
			...
			# Se eliminó la restricción estricta de "currency_id != fiscal"
	...
	def _create_payment_vals_from_wizard(self, batch_result):
		...
		payment_vals.update({
			...
			'igtf_journal_id': self.company_id.igtf_journal_id.id if self.company_id.igtf_journal_id else False,
		})
		return payment_vals
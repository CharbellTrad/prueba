...
class CashFlowReportCustomHandler(models.AbstractModel):
    ...
    def _get_liquidity_moves(self, report, options, currency_table_query, payment_account_ids, payment_move_ids, cash_flow_tag_ids=None):
        ...
        :param payment_account_ids:     A tuple containing all account.account's ids being used in a liquidity journal.
        :param cash_flow_tag_ids:       A tuple containing the cash flow tag ids.
    ...
    def _get_reconciled_moves(self, report, options, currency_table_query, payment_account_ids, payment_move_ids, cash_flow_tag_ids=None):
        ...
        if options.get('selected_currency') != self.env.company.currency_ref_id.id:
            return super()._get_reconciled_moves(report, options, currency_table_query, payment_account_ids, payment_move_ids, cash_flow_tag_ids)
        if not payment_move_ids:
            return []

...
class SaleOrder(models.Model):
	...
	@api.depends('order_line.price_subtotal', 'order_line.price_tax', 'currency_rate_ref')
	...
	@api.depends('order_line.tax_id', 'order_line.price_unit', 'amount_total', 'amount_untaxed', 'currency_rate_ref')

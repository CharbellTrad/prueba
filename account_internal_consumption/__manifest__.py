{
    ...
    'assets': {
        'web.assets_backend': [
             ...
             'account_internal_consumption/static/src/css/internal_consumption_config.css',
        ],
        'point_of_sale._assets_pos': [
            ...
            'account_internal_consumption/static/src/app/components/error_dialog/internal_consumption_error_dialog.js',
            'account_internal_consumption/static/src/app/components/error_dialog/internal_consumption_error_dialog.xml',
            'account_internal_consumption/static/src/app/components/error_dialog/internal_consumption_error_dialog.scss',
            'account_internal_consumption/static/src/css/internal_consumption_type_selector.scss',
